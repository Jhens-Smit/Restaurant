            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="../vista/index.php" class="nav-item nav-link">Inicio</a>
                        <a href="../vista/about.php" class="nav-item nav-link active">Nosotros</a>
                        <a href="../vista/service.php" class="nav-item nav-link">Servicios</a>
                        <a href="../vista/menu.php" class="nav-item nav-link">Menu</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Páginas</a>
                            <div class="dropdown-menu m-0">
                                <a href="../vista/booking.php" class="dropdown-item">Reservas</a>
                                <a href="../vista/team.php" class="dropdown-item">Nuestro equipo</a>
                                <a href="../vista/testimonial.php" class="dropdown-item">Testimonios</a>
                            </div>
                        </div>
                        <a href="../vista/contact.php" class="nav-item nav-link">Contactos</a>
                    </div>
                    <a href="" class="btn btn-primary py-2 px-4">Reservas</a>
                </div>
            </nav>
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item"><a href="../vista/booking.php">Páginas</a></li>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Bienvenidos al rico sabor <i class="fa fa-utensils text-primary me-2"></i>Restaurante sabor a Charapita</h1>
        ...
        <div class="container-xxl pt-5 pb-3">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Nuestros Chefs</h1>
                </div>
                <div class="row g-4">
            ...
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jr. Bolognesi #256 El Tambo-Huancayo</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>954440041</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>salazarascanoaedwineduardo @gmail.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <h5 class="text-light fw-normal">Lunes-Jueves</h5>
                        <p>08:00AM - 05:30PM</p>
                        <h5 class="text-light fw-normal">Viernes-Sábado</h5>
                        <p>08:00AM - 10:30PM</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                            ...
                            <button type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">Iniciar</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-left text-md-left">
                            <div class="footer-menu">
                                ...
                                <a href="../vista/about.php">Información</a>
                            </div>
                        </div>
                    </div>
                </div>
