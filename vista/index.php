            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="../vista/index.php" class="nav-item nav-link active">Inicio</a>
                        <a href="../vista/about.php" class="nav-item nav-link">Nosotros</a>
                        <a href="../vista/service.php" class="nav-item nav-link">Servicio</a>
                        <a href="../vista/menu.php" class="nav-item nav-link">Menú</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Paginas</a>
                            <div class="dropdown-menu m-0">
                                <a href="../vista/booking.php" class="dropdown-item">Reserva</a>
                                <a href="../vista/team.php" class="dropdown-item">Nuestro Equipo</a>
                                <a href="../vista/testimonial.php" class="dropdown-item">Testimonial</a>
                            </div>
                        </div>
                        <a href="../vista/contact.php" class="nav-item nav-link">Contacto</a>
                    </div>
                    <a href="" class="btn btn-primary py-2 px-4">Reservar una Mesa</a>
                </div>
            </nav>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Bienvenidos <i class="fa fa-utensils text-primary me-2"></i>Restaurante</h1>
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href="">Lee mas</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">Reserve una mesa en línea</h1>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
